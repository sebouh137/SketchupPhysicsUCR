...
cp BPC0001.png $outdir/BPC_closed.png
cp BPC0002.png $outdir/BPC_open.png
#cp BPC0004.png $outdir/BPC_open_full_beampipe.png
cp BPC0003.png $outdir/layer_structure.png
cp BPC0004.png $outdir/explode_view.png
cp BPC0005.png $outdir/absorber.png
cp BPC0006.png $outdir/scint_cover.png
cp BPC0007.png $outdir/scint_from_upstream.png
cp BPC0008.png $outdir/scint_from_downstream.png
cp BPC0009.png $outdir/pcb.png
cp BPC0010.png $outdir/endcap.png
cp BPC0011.png $outdir/adjacent.png
cp BPC0012.png $outdir/adjacent_2.png
